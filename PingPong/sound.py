    ...
    def _play_sound(self, sound_type):
        ...
        try:
            if sys.platform.startswith("win"):
                ...
                frequencies = {"bounce": 500, "score": 800, "powerup": 1200}
                durations = {"bounce": 100, "score": 300, "powerup": 200}
                winsound.Beep(
                    frequencies.get(sound_type, 500), durations.get(sound_type, 100)
                )
            elif sys.platform.startswith("darwin"):  # macOS
                sounds = {"bounce": "ping", "score": "tink", "powerup": "pop"}
                os.system(
                    f"afplay /System/Library/Sounds/{sounds.get(sound_type, 'ping')}.aiff &"
                )
            else:  # Linux and others
                frequencies = {"bounce": "500", "score": "800", "powerup": "1200"}
                durations = {"bounce": "0.1", "score": "0.3", "powerup": "0.2"}
                try:
                    import subprocess
                    ...
                    subprocess.Popen(
                        [
                            ...
                            "sine",
                            frequencies.get(sound_type, "500"),
                        ]
                    )
                except:
